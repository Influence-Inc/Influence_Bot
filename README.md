...
- **24h review auto-approval** — Sweeps every 30 min to auto-approve reviews left un-actioned for 24h. Any message in the chat from someone other than the creator (brand or INFLUENCE) means the review is being worked and stops the clock for that campaign; the creator's own messages don't
